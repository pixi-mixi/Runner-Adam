...
BUILDING_MAX_LEVEL = {
    BuildingCategory.OPI: 19,
    BuildingCategory.MEDIC: 14,
    BuildingCategory.MEDIC_HELI: 3,
    BuildingCategory.OPP: 35,
    BuildingCategory.SM: 7,
    BuildingCategory.JRG: 25,
}
...
class Building:
    ...
    @property
    def calculated_space(self):
        if self.category == BuildingCategory.OPP:
            return self.level + 5
        return self.level + 1
